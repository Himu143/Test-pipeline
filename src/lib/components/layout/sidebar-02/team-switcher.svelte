<script lang="ts">
	import CaretSort from '@lucide/svelte/icons/chart-no-axes-gantt';
	import Check from '@lucide/svelte/icons/check';
	import PlusCircled from '@lucide/svelte/icons/heart-pulse';
					...
					{#each groups as group}
						<Command.Group heading={group.label}>
							{#each group.teams as team}
								<Command.Item value={team.label} class="text-sm">
									<Avatar.Root class="mr-2 h-5 w-5">
										<Avatar.Image
